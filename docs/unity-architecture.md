...
├── README.md
├── LICENSE.md                                    Apache License 2.0 (#15)
├── NOTICE                                        Apache 2.0 §4(d) attribution chain (Phosphor MIT 等)
├── THIRD_PARTY_NOTICES.md                        Phosphor (MIT) / UdonSharp (MIT) / Newtonsoft.Json (MIT) / VRChat SDK (EULA) 全文
├── CHANGELOG.md
├── Runtime/
